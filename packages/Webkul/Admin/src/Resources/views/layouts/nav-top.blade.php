<div class="navbar-top">
    ...
    <div class="navbar-top-right">
        ...
        @push('scripts')
            <script type="text/x-template" id="user-notification-template">
                
                <div class="notification-create">
                    <span class="button dropdown-toggle">
                        <i class="icon notification-icon"></i>

                        <span class="badge notification-badge" v-if="notificationsCount">
                            <span class="notification-count" v-text="notificationsCount"></span>
                        </span>
                    </span>

                    <div class="dropdown-list">
                        <div class="dropdown-container" v-if="notificationsCount">
                            <ul>
                                <li v-for="notification in notifications">
                                    <a :href="notification.link"
                                        class="notification-title"
                                        @click="readNotification(notification.notifiable_id)" 
                                ...
                                <li class="no-border">
                                    <div class="more-items">
                                        <a href="{{ route('admin.notification.mark-as-read')}}" class="text-link text-14-semibold text-lh-20">
                                            @lang('admin::app.layouts.nav-top.mark-read')    
                                        </a>

                                        <a href="{{ route('admin.notification.index')}}" class="text-link text-14-semibold text-lh-20">
                                            @lang('admin::app.layouts.nav-top.view-notification')     
                                        </a>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <div v-else class="dropdown-container">
                            <ul>
                                <li class="no-border">
                                    @lang('admin::app.layouts.nav-top.new-notification')
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <script>
                Vue.component("user-notification", {
                    ...
                    methods: {
                        readNotification(notifiable_id) {
                            axios
