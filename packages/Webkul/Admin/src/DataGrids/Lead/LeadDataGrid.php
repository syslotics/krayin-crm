...
class LeadDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        $queryBuilder = DB::table('leads')
            ->addSelect(
                ...
                'lead_person.pickup_date as pickup_date',
                'lead_person.pickup_time as pickup_time',
            ...
            ->leftJoin('lead_person', 'leads.id', '=', 'lead_person.lead_id')
        ...
        $this->addFilter('pickup_time', 'lead_person.pickup_time');
    ...
    public function addColumns()
    {
        ...
        $this->addColumn([
            'index'    => 'pickup_date',
            'label'    => trans('admin::app.datagrid.pickup_date'),
            'type'     => 'date_range',
            'sortable' => true,
        ]);
        ...
        $this->addColumn([
            'index'    => 'pickup_time',
            'label'    => trans('admin::app.datagrid.pickup_time'),
            'type'     => 'time',
            'sortable' => true,
        ]);
