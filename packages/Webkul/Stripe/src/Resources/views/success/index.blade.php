...
<head>
    ...
    <title>@lang('stripe::app.success.index.success')</title>
</head>
            ...
            <div style="text-align: center;">
                <div style="font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 34px;">
                    <h1 style="font-size: 24px;">
                        @lang('stripe::app.success.index.success')
                    </h1>
                </div>

                <p style="font-size: 16px;">
                    @lang('stripe::app.success.index.info')
                </p>
                ...
                <a href="{{ route('admin.quotes.edit', ['id' => $quoteId]) }}" style="padding: 10px 20px;background: #0041FF;color: #ffffff;text-transform: uppercase;text-decoration: none; font-size: 16px">
                    @lang('stripe::app.success.index.return-btn' , ['id' => $quoteId])
                </a>
            </div>
        </div>
    </div>
