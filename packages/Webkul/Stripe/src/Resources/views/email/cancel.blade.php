...
<head>
    ...
    <title>@lang('stripe::app.email.cancel.subject')</title>
</head>
<body>
    ...
    <div style="padding: 30px;">
        <div style="font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 34px;">
            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                @lang('stripe::app.email.cancel.dear', ['name' => $name]),
            </p>
            ...
            >
                @lang('stripe::app.email.cancel.info', ['id' => $quote->id])
            </a>

            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                @lang('stripe::app.email.cancel.thanks')
            </p>
        </div>
    </div>
</body>
