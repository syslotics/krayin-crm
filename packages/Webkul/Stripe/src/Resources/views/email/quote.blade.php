...
<head>
    ...
    <title>
        @lang('stripe::app.email.quote.subject', ['id' => '#' . $quote->id])
    </title>
</head>
    ...
    <div style="padding: 30px;">
        <div style="font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 34px;">
            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                @lang('stripe::app.email.quote.dear', ['name' => $name]),
            </p>

            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                @lang('stripe::app.email.quote.info', ['id' => '#'.$quote->id])
            </p>
            ...
            <p style="text-align: center;padding: 20px 0;">
                ...
                >
                    @lang('stripe::app.email.quote.view', ['id' => $quote->id])
                </a>
            </p>

            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                @lang('stripe::app.email.quote.thanks')
            </p>
