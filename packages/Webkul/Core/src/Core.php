...
class Core
{
     ...
     * @return array
     */
    public function getNotificationDetail($key, $id)
    {
        $notificationData = [];
        ...
        $notificationData['title'] = "New $notificationKeys[$key] #$id has been created";
        $notificationData['content'] = 'Hi, you have received a new '.strtolower($notificationKeys[$key]).'';
