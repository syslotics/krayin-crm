...
Breadcrumbs::for('drivers', function (BreadcrumbTrail $trail) {
    $trail->parent('dashboard');
    $trail->push(trans('drivers::app.common.index.title'), route('drivers.information.index'));
});

Breadcrumbs::for('drivers.create', function (BreadcrumbTrail $trail) {
    $trail->parent('drivers');
    $trail->push(trans('drivers::app.layouts.create'), route('drivers.information.create'));
});

Breadcrumbs::for('drivers.edit', function (BreadcrumbTrail $trail, $driver) {
    $trail->parent('drivers');
    $trail->push(trans('drivers::app.layouts.edit'), route('drivers.information.edit', $driver->id));
});
